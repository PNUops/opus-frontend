  ...
  return (
    <AdminCard>
      ...
      <div className="flex items-center gap-3.5 p-3.5">
        <div className="bg-subGreen rounded-lg p-2.5">2025 SW프로젝트 관리시스템 개발 계획</div>
        <a href={DEVELOPMENT_PLAN_URL} target="_blank" className="underline underline-offset-2">
